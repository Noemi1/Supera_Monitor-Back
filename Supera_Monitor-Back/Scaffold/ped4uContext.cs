...
public partial class ped4uContext : DbContext
{
    public ped4uContext()
    {
    }

    public ped4uContext(DbContextOptions<ped4uContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=bccorreios.database.windows.net;Initial Catalog=ped4u;Persist Security Info=True;User ID=bccorreios;Password=C@domeew1;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AccountRefreshToken>(entity =>
        {
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.AccountRefreshTokens).HasForeignKey(d => d.Account_Id);
        });
        ...
        modelBuilder.Entity<Aula_Aluno>(entity =>
        {
            ...
            entity.HasOne(d => d.ReposicaoDe_Aula).WithMany(p => p.Aula_Alunos)
                .HasForeignKey(d => d.ReposicaoDe_Aula_Id)
