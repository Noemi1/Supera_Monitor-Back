...
namespace Supera_Monitor_Back.Migrations
{
    ...
    [Migration("20250115122638_AccountRoleShouldNotBeNull")]
    partial class AccountRoleShouldNotBeNull
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Supera_Monitor_Back.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AcceptTerms = true,
                            Created = new DateTime(2025, 1, 15, 9, 26, 38, 179, DateTimeKind.Local).AddTicks(5417),
                            ...
                            Role_Id = 0,
                            VerificationToken = "",
                            Verified = new DateTime(2025, 1, 15, 9, 26, 38, 179, DateTimeKind.Local).AddTicks(5405)
                        });
                });
